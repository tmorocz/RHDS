(function () {
  ...
  var jqPlotWidget = function (settings) {
    ...
    this.render = function (element) {
      ...
      //add external css
      $(element).append('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqPlot/1.0.8/jquery.jqplot.min.css" />');      
  ...
  freeboard.loadWidgetPlugin({
    ...
    "external_scripts": [
      ...
      "https://cdnjs.cloudflare.com/ajax/libs/jqPlot/1.0.8/plugins/jqplot.pieRenderer.min.js",
      "https://cdnjs.cloudflare.com/ajax/libs/jqPlot/1.0.8/plugins/jqplot.barRenderer.min.js",
      "https://cdnjs.cloudflare.com/ajax/libs/jqPlot/1.0.8/plugins/jqplot.categoryAxisRenderer.min.js",
      "https://cdnjs.cloudflare.com/ajax/libs/jqPlot/1.0.8/plugins/jqplot.pointLabels.min.js"
    ],    
    "settings": [
      {
        "name": "id",
